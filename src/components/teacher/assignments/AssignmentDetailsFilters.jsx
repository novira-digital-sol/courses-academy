...
const STATUS_OPTIONS = ["جميع الطلاب", "تم التسليم", "لم يسلّم"];

const AssignmentDetailsFilters = ({ search, onSearchChange, filterStatus, onFilterStatusChange }) => {
  return (
...
export default AssignmentDetailsFilters;